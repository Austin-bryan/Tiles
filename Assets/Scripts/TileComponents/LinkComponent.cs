...
{
    public class LinkComponent : TileComponent
    {
        ...
        private static LinkedTiles linkedTiles  = new Dictionary<int, List<PlayerTile>>();
        private static List<int> tilesActivated = new List<int>();
        private static List<int> linksActivated = new List<int>();
        private List<int> links                 = new List<int>();

        public LinkComponent(PlayerTile playerTile, List<string> parameters, bool oneSwipeOnly = false) : base(playerTile, parameters, -1, oneSwipeOnly)
        {
