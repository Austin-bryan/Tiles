...
{
    public class DiagonalComponent : TileComponent
    {
        public override TileType TileType => TileType.Diagonal;
        private Vector3 originalScale;

        public DiagonalComponent(PlayerTile playerTile, List<string> parameters, bool oneSwipeOnly = false) : base(playerTile, parameters, DiagonalIndex, oneSwipeOnly)
        {
        ...
        public override void SetVisibility(bool isVisible)
        {
            ...
            Tile.SetSwipeMode(isVisible ? SwipeStyle.Diagonal    : SwipeStyle.Layer, true);
