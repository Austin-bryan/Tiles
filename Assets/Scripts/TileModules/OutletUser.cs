...
{
    public abstract class OutletUser : TileModule
    {
        ...
        protected void UpdatePlugInStatus()
        {
            ...
            bool IsOutlet(int dir) => BoardManager.PBoard[Tile.Coord + (Direction)dir]?.To<PlayerTile>().Sides.HasModule(TileType.Outlet) ?? false;
        }
    }
}
