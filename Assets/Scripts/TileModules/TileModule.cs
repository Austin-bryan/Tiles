...
{
    public abstract class TileModule : IPlayerTile
    {
        // --------  Public Fields  -------- //
        public static List<(int, TileType)> ActivatedModules { get; set; } = new List<(int, TileType)>();

        public abstract TileType TileType       { get; }
        public bool WasSwipedThisRound          => SwipeManager.ModulesSweptThisSwipe.Contains(this);
        ...
        // --------  Protected Fields -------- //
        protected bool WasActivatedThisRound => ActivatedModules.Contains((Tile.ID, TileType));
        ...
        // ≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡    Methods    ≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡ //
        public TileModule(PlayerTile playerTile, List<string> parameters, int index, bool oneSwipeOnly = false) : this(playerTile, parameters, new[] { index }, oneSwipeOnly) { }
        public TileModule(PlayerTile playerTile, List<string> parameters, int[] indexes, bool oneSwipeOnly = false)
        {
        ...
        public virtual void OnLevelMemberGroup()  { }
        ...
        public virtual void IntiateSwipe(Direction direction, bool playerTriggered) { }
        ...
        protected bool TrySwipe()
        {
            ...
            SwipeManager.ModulesSweptThisSwipe.Add(this);
            return true;
        }
    }
}