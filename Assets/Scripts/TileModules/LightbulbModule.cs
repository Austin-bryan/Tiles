...
{
    public class LightbulbModule : OutletUser
    {
        public override bool SubscribeToAllMoves => true;
        public override TileType TileType => TileType.Lightbulb;
        private int spriteIndex;

        public LightbulbModule(PlayerTile playerTile, List<string> parameters, int index, bool oneSwipeOnly = false) : base(playerTile, parameters, index, oneSwipeOnly) => spriteIndex = index;
