...
{
    public class FiniteUseModule : TileModule
    {
        // ≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡    Properties      ≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡ //
        ...
        // ≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡    Methods    ≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡ //
        public FiniteUseModule(PlayerTile playerTile, List<string> parameters, int index, bool oneSwipeOnly = false) : base(playerTile, parameters, index, oneSwipeOnly) => UseCount = UsesRemaining = parameters[0].Parse();
        ...
        private void Deactivate()
        {
            ...
            Tile.AddModule(DeactivatedType, factory.GetModule(Tile, new List<string>()));
            Tile.AddModules();
